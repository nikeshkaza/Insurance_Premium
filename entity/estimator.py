...
from config.aws_connection_config import AWSConnectionConfig

class CloudEstimator(ABC):
    key = "modelregistry1901"
...
class InsuranceComplaintEstimator:
...
class S3InsuranceEstimator(InsuranceComplaintEstimator, S3Estimator):
    ...
    def get_latest_model_path(self) -> str:
        ...
        return InsuranceComplaintEstimator.get_latest_model_path(self)
